    ...
    for (let empData of empDataList) {
        ...
        tableData =
            ...
            <tr>
                ...
                <td>
                    <img src="../assets-20220927T065615Z-001/assets/icons/delete-black-18dp.svg" id="${empData._id}" onclick="remove(this)" alt="">
                    <img src="../assets-20220927T065615Z-001/assets/icons/create-black-18dp.svg" id="${empData._id}" onclick="update(this)" alt="">
                </td>
            </tr>
            `;
    }
